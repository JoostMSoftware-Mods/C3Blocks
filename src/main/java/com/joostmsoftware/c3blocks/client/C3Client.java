...
public class C3Client implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ItemGroup GROUP = FabricItemGroupBuilder.create(C3.ID("group"))
                .appendItems((itemStacks, itemGroup) -> blockList.forEach(block -> itemStacks.add(block.asItem().getDefaultStack())))
                .build();
